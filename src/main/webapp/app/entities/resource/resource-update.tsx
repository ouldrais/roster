  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rosterApp.resource.home.createOrEditLabel" data-cy="ResourceCreateUpdateHeading">
            <Translate contentKey="rosterApp.resource.home.createOrEditLabel">Create or edit a Resource</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('rosterApp.resource.key')} id="resource-key" name="key" data-cy="key" type="text" />
              <ValidatedField
                label={translate('rosterApp.resource.firstName')}
              ...
              />
              <ValidatedField
                label={translate('rosterApp.resource.lastName')}
              ...
              />
              <ValidatedField
                label={translate('rosterApp.resource.teamRole')}
              ...
              <ValidatedField
                ...
                type="checkbox"
              />
              <ValidatedField id="resource-team" name="team" data-cy="team" label={translate('rosterApp.resource.team')} type="select">
                <option value="" key="0" />
                {teams
