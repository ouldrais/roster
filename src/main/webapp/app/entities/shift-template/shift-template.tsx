  ...
  return (
    <div>
      <h2 id="shift-template-heading" data-cy="ShiftTemplateHeading">
        <Translate contentKey="rosterApp.shiftTemplate.home.title">Shift Templates</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="rosterApp.shiftTemplate.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/shift-template/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="rosterApp.shiftTemplate.home.createLabel">Create new Shift Template</Translate>
          </Link>
        </div>
      </h2>
        ...
        {shiftTemplateList && shiftTemplateList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="rosterApp.shiftTemplate.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('key')}>
                  <Translate contentKey="rosterApp.shiftTemplate.key">Key</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('key')} />
                </th>
                <th className="hand" onClick={sort('shiftStart')}>
                  <Translate contentKey="rosterApp.shiftTemplate.shiftStart">Shift Start</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('shiftStart')} />
                </th>
                <th className="hand" onClick={sort('shiftEnd')}>
                  <Translate contentKey="rosterApp.shiftTemplate.shiftEnd">Shift End</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('shiftEnd')} />
                </th>
                <th className="hand" onClick={sort('type')}>
                  <Translate contentKey="rosterApp.shiftTemplate.type">Type</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="rosterApp.shiftTemplate.home.notFound">No Shift Templates found</Translate>
            </div>
          )
        )}
      </div>
