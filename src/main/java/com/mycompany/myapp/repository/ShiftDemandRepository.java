...
public interface ShiftDemandRepository extends JpaRepository<ShiftDemand, Long> {
    ...
    @Query(
        value = "select shiftDemand from ShiftDemand shiftDemand left join fetch shiftDemand.shift left join fetch shiftDemand.department",
    ...
    @Query("select shiftDemand from ShiftDemand shiftDemand left join fetch shiftDemand.shift left join fetch shiftDemand.department")
    List<ShiftDemand> findAllWithToOneRelationships();

    @Query(
        "select shiftDemand from ShiftDemand shiftDemand left join fetch shiftDemand.shift left join fetch shiftDemand.department where shiftDemand.id =:id"
    )
